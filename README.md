...
├── docs/                        # Operations guide, screener walkthrough,
│   └── architecture/            #   design docs + the 2026-06 audit register
├── ui/                          # Streamlit page modules (REF-001): history,
│                                #   admin health, chart cache, shared helpers
