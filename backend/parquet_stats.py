...
the first and last candle dates can usually be answered by reading a few
...
decisions ("is this file already fresh?", "does it cover the requested
range?"), which previously loaded the entire frame just to learn two dates.
