...
| Forward-return validation | [validation](components/validation.md) | VALID-002 calculator/service plus VALID-003A aggregate metrics for `signal_forward_returns` rows |
