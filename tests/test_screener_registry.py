...
def test_discover_screeners_loads_stochastic_swing():
    ...
    # The 67 ka funda screener scans Super 45 + Good 45 + Good 200.
    assert screeners["sixty_seven_ka_funda"].universe == "hemant_super_good_200_union"
    ...
    assert screeners["sixty_seven_ka_funda"].build_chart is not None
